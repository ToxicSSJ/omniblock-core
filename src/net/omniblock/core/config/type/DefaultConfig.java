...
public class DefaultConfig implements Config {
	...
	@Override
	public DefaultConfig create(String filename) throws URISyntaxException, IOException {
		...
		if(!file.exists()){
			...
			InputStream stream = DefaultConfig.class.getResourceAsStream("/config/" + filename);
