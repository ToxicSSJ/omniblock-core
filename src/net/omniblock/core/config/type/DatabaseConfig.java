...
public class DatabaseConfig implements Config {
	...
	@Override
	public DatabaseConfig create(String filename) throws URISyntaxException, IOException {
		...
		if(!file.exists()){
			...
			InputStream stream = DatabaseConfig.class.getResourceAsStream("/config/" + filename);
